    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh "scp -o StrictHostKeyChecking=no -i /var/lib/jenkins/workspace/First_Maven_project/harshalTomcat.pem /var/lib/jenkins/workspace/Hello_World_Pipeline/webapp/target/webapp.war ec2-user@54.164.214.8:/opt/apache/webapps/"
